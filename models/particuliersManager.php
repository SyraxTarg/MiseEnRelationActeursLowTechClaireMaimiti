...
class particuliersManager extends AbstractManager {
    ...
    function getParticuliers($desc_or_asc){
        $sql = "SELECT id_user, profile_picture, Users.username, Users.password, Users.email, particuliers.activit‚s  FROM ".particuliersManager::TABLE_NAME." JOIN Users ON ".particuliersManager::TABLE_NAME.".id_user = Users.id ORDER BY username ".$desc_or_asc.";";

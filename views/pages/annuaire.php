...
<div id="pageAnnuaire">
    ...
    <table id="annuaire">
        ...
        <?php 
        $users = array_merge($particuliers, $modos);
        foreach ($users as $user) {
            if ($user['username'] != 'utilisateur introuvable') {
                echo "<tr>";
                echo "<td class='nomImage'><a href='index.php?page=profil&id=".$user['id_user']."'>";
                $image = "./public/images/defaultPfp.png";
                if ($user['profile_picture'] == null) {
                    echo "<img src =" . $image . " alt='default pfp' class='pfpAnnuaire'/>";
                } else {
                    echo "<img src ='" . $user['profile_picture'] . "' alt='pfp' class='pfpAnnuaire'/>";
                }

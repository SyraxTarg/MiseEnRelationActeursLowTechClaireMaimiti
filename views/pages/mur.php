...
foreach ($annoncesPaginees as $index => $annonce) {
    ...
    <div class="annonceMur" style="overflow: hidden; word-wrap:break-word;">
        ...
        <form method="post" action="" class="formLike">
            ...
            <p>
                <span id="likes-count-<?php echo $annonceId; ?>" class="nbLikesMur"><?php echo $annonce['nb_likes']; ?></span>
                <?php if ($isLoggedIn) : ?>
                    <button type="submit" name="like[<?php echo $index; ?>]" class="like-btn-mur" data-is-liked="<?php echo $etatBouton; ?>">
